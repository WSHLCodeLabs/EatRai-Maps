    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={[styles.header, { borderBottomColor: colors.border }]}>
                ...
                <Text style={[styles.headerTitle, { color: colors.textPrimary }]}>Saved Places</Text>
            ...
            <View style={styles.emptyContainer}>
                ...
                <Text style={[styles.emptyTitle, { color: colors.textPrimary }]}>No Saved Places Yet</Text>
                ...
                <TouchableOpacity
                    ...
                    activeOpacity={0.7}
                >
                    <Ionicons name="compass-outline" size={20} color="#0D0D0D" />
