...
export const INITIAL_RESTAURANTS: Restaurant[] = [
    ...
    },
    {
        ...
        rating: 4.7,
        tag: 'NEW',
        imageUrl: require('@/assets/images/restaurants/coco.png'),
        latitude: 14.02638201439211,
        longitude: 99.97453305322013,
        crowdReports: { quiet: 5, moderate: 3, busy: 1 },
        crowdLevel: 'Quiet',
    },
    {
        id: '12',
        name: 'Max Beef Cowboyland KU KPS',
        cuisine: 'Steakhouse',
        distance: '200 m',
        rating: 4.8,
        tag: 'NEW',
        imageUrl: require('@/assets/images/restaurants/maxbeef.png'),
        latitude: 14.025301272674017,
        longitude: 99.96961668132398,
        crowdReports: { quiet: 5, moderate: 3, busy: 1 },
        crowdLevel: 'Quiet',
    },
];
